...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton CmdStartWake 
      Appearance      =   0  'Flat
      Caption         =   "Ενεργοποίηση Αφύπνισης"
      Height          =   485
      Left            =   2790
      Style           =   1  'Graphical
      TabIndex        =   2
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ButtonMenus {66833FEC-8583-11D1-B16A-00C0F0283628} 
               NumButtonMenus  =   2
               BeginProperty ButtonMenu1 {66833FEE-8583-11D1-B16A-00C0F0283628} 
                  Text            =   "Αποθήκευση Λίστας"
               EndProperty
               BeginProperty ButtonMenu2 {66833FEE-8583-11D1-B16A-00C0F0283628} 
                  Text            =   "Ανάκτηση Λίστας"
               EndProperty
            EndProperty
         EndProperty
...
Dim cou%
    If Button = vbRightButton Then
        If listviewOnAir.ListItems.count > 0 Then
            ...
            Else
                If gLang = "Greek" Then
                    MsgBox "Δεν μπορείς να διαγράψεις το τραγούδι που παίζει.", vbInformation
                Else
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Select Case Button
        ...
        Case "Έξοδος", "Exit"
            If MediaPlayer1.CurrentPosition > 0 Then
                    If gLang = "Greek" Then
                        MsgBox "Δεν είναι εφικτή η έξοδος κατά την διάρκεια ακρόασης τραγουδιού.", vbInformation
                    Else
            ...
            End If
            If gLang = "Greek" Then
                ans% = MsgBox("Είσαι σίγουρος για την έξοδο από το πρόγραμμα;", vbOKCancel + vbDefaultButton2)
            Else
...
Private Sub Toolbar1_ButtonMenuClick(ByVal ButtonMenu As MSComctlLib.ButtonMenu)
   ...
   Select Case ButtonMenu
        Case "Προσθήκη Τραγουδιού", "Add Songs"
            Form2.Show
        Case "Διαγραφή Επιλεγμένων", "Remove Selected"
            If listviewOnAir.ListItems.count > 0 Then
                        If listviewOnAir.SelectedItem.ListSubItems(2) <> LblCurSong.Caption Then
            ...
            Else
                If gLang = "Greek" Then
                    MsgBox "Δεν υπάρχουν επιλεγμένα τραγούδια.", vbInformation
                Else
                    MsgBox "There are no songs selected.", vbInformation
                End If
            End If
        Case "Διαγραφή Όλων", "Remove All"
            If listviewOnAir.ListItems.count > 0 Then
                If MediaPlayer1.CurrentPosition > 0 Then
                    If gLang = "Greek" Then
                        MsgBox "Δέν μπορείς να διαγράψεις όλα τα τραγούδια κατά την διάρκεια της ακρόασης." _
                            , vbInformation
                    Else
                ...
                Else
                If gLang = "Greek" Then
                    ans% = MsgBox("Είσαι σίγουρος για την διαγραφή όλης της λίστας;", vbOKCancel + vbDefaultButton2)
                Else
            ...
            Else
                If gLang = "Greek" Then
                    MsgBox "Δέν υπάρχουν τραγούδια για διαγραφή.", vbInformation
                Else
        ...
        Case "Αποθήκευση Λίστας", "Save List               "
            If listviewOnAir.ListItems.count > 0 Then
                FrmSaveList.Show
            Else
                If gLang = "Greek" Then
                    MsgBox "Δεν υπάρχουν τραγούδια προς αποθήκευση.", vbInformation
                Else
                    MsgBox "There are no songs to save.", vbInformation
                End If
            End If
        Case "Ανάκτηση Λίστας", "Load List               "
            Form3.Show
    End Select
    Exit Sub
...
If Len(Trim$(TxtWakeHour.Text)) Then
    If IsNumeric(TxtWakeHour.Text) Then
        If CInt(TxtWakeHour.Text) > 23 Then
            If gLang = "Greek" Then
                MsgBox "Παρακαλώ διορθώστε την ώρα.", vbInformation
            Else
...
If Len(txtwakeMin.Text) Then
    If IsNumeric(txtwakeMin.Text) Then
        If CInt(txtwakeMin.Text) > 59 Then
            If gLang = "Greek" Then
                MsgBox "Παρακαλώ διορθώστε τα λεπτά.", vbInformation
            Else
